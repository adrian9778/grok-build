...
| [07-TUI专题.md](07-TUI专题.md) | TUI 技术栈、架构、事件流、第三方框架、交互流程 | 前端/终端交互、研发 |
| [08-运行时与会话专题.md](08-运行时与会话专题.md) | Shell/Agent 会话路由、回合执行、ACP 与 headless 模式 | 平台架构、研发 |
| [09-工具与扩展专题.md](09-工具与扩展专题.md) | Tool Runtime、MCP、Hook、插件、权限审批链路 | 研发、平台、测试 |
| [10-工作区与数据专题.md](10-工作区与数据专题.md) | Workspace、文件系统、索引、变更归因、持久化与沙箱 | 研发、运维、安全 |
| [11-补充专题-参考现有源码解读.md](11-补充专题-参考现有源码解读.md) | 将 `docs/sourcecode` 与设计文档内容对齐，补齐边界条件与术语映射 | 架构师、研发 |
